...
ALfloat modalTranslate[3] = {0.0f, 0.0f, -6.0f};
...
void initializeAudio(void)
{
    ...
    else
    {
        ...
        ALboolean waveDataLoaded = audioManager->loadWaveAudio("resources/audio/sound1.wav", audioBufferId);
...
void drawPyramid()
{
    ...
    modelMatrix = vmath::translate(modalTranslate[0], modalTranslate[1], modalTranslate[2]);
