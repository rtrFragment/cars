...
bool g_scene2_bShowScene2 = true;
...
/// Audio Start
AudioManager *g_pAM_Scene2_AudioManager = NULL;
SoundSource  *g_pSS_Scene2_SoundSource = NULL;
ALuint g_Scene2_AudioBuffer_LoopSound = 0;
bool g_scene2_1_PlayAudio = true;
/// Audio End

void Scene2_InitializeAudio(void)
{
	g_pAM_Scene2_AudioManager = new AudioManager();
	ALboolean bAudioManagerInit = g_pAM_Scene2_AudioManager->initialize();

	if (bAudioManagerInit == AL_TRUE)
	{
		g_pAM_Scene2_AudioManager->setListenerPosition(0.0f, 0.0f, 0.0f);
		g_pAM_Scene2_AudioManager->setListenerVelocity(0.0f, 0.0f, 0.0f);
		...
		ALboolean waveDataLoaded = g_pAM_Scene2_AudioManager->loadWaveAudio("resources/audio/Castamere.wav", g_Scene2_AudioBuffer_LoopSound);
...
void Scene2_Initialize(void)
{
	...
	/// Text Config Start
	frFontRenderer_InletletValveText = new FontRenderer("fonts/AlegreyaSans-MediumItalic.ttf", 72);
	...
	frFontRenderer_OutletletValveText = new FontRenderer("fonts/AlegreyaSans-MediumItalic.ttf", 72);
	...
	frFontRenderer_PistonText = new FontRenderer("fonts/AlegreyaSans-MediumItalic.ttf", 72);
	...
	frFontRenderer_SparkPlugText = new FontRenderer("fonts/AlegreyaSans-MediumItalic.ttf", 72);
	...
	frFontRenderer_IntakeText = new FontRenderer("fonts/AlegreyaSans-Bold.ttf", 78);
	...
	frFontRenderer_CompressionText = new FontRenderer("fonts/AlegreyaSans-Bold.ttf", 78);
	...
	frFontRenderer_PowerText = new FontRenderer("fonts/AlegreyaSans-Bold.ttf", 78);
	...
	frFontRenderer_ExhaustText = new FontRenderer("fonts/AlegreyaSans-Bold.ttf", 78);
	...
	tdExhaustText.textColor = glm::vec3(0.0f, 0.0f, 0.0f);
