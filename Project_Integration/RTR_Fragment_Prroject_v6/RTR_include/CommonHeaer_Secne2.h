...
GLuint g_scene2_1_BlackoutColor;
...
GLfloat blackOutColor[] = { 1.0f,1.0f,1.0f,1.0f };
...
GLuint g_scene2_1_Uniform_Rect_BlackoutColor;
...
GLint g_scene2_1_BlackOut_inlet = 0;
...
GLint g_scene2_1_BlackOut_Outlet = 0;
...
GLint g_scene2_1_BlackOut_Particle_Spark = 0;
...
GLuint g_scene2_1_Uniform_BlackOut_Line;
...
void Scene2_Initialize(void)
{
	...
	const GLchar *fragmentShaderSourceCode =
		...
		"	}" \
		"	FragColor = vec4(phong_ads_color,1.0) * u_BlackOutColor;" \
		"}";
	...
	g_scene2_1_BlackoutColor = glGetUniformLocation(g_scene2_1_ShaderProgramObject, "u_BlackOutColor");
	...
	const GLchar *fragmentShaderSourceCodeRect = "#version 460 core"	\
		...
		"void main (void)" \
		"{"	\
		"	FragColor = vec4(out_Color,0.4f) * u_BlackOutColor;"	\
		"}";
	...
	g_scene2_1_Uniform_Rect_BlackoutColor = glGetUniformLocation(g_scene2_1_ShaderProgramObject_Rectangle, "u_BlackOutColor");
	...
	const GLchar* chFragmentShaderSourceCode_Inlet = "#version 460 core"	\
		...
		"		discard;"	\
		"	}"	\
		"	FragColor = vec4(out_Color.r, out_Color.g, out_Color.b, 0.4f) * u_BlackOutColor ;"	\
		"}";
	...
	g_scene2_1_BlackOut_inlet = glGetUniformLocation(g_scene2_1_ShaderProgramObject_Particle_Inlet, "u_BlackOutColor");
	...
	// u_BlackOutColor
	g_scene2_1_BlackOut_Outlet = glGetUniformLocation(g_scene2_1_ShaderProgramObject_Particle_Outlet, "u_BlackOutColor");
	// ***** Begin : All Vertices, Normals, Texture amd Etc data/Bindings *****
	...
	const GLchar *chFragmentShaderSourceCode_Spark =
		...
		"		discard;"	\
		"	}"	\
		"	FragColor = vec4(out_Color.r, out_Color.g, out_Color.b, 0.3) * u_BlackOutColor;"	\
		"}";
	...
	g_scene2_1_BlackOut_Particle_Spark = glGetUniformLocation(g_scene2_1_ShaderProgramObject_Spark, "u_BlackOutColor");
	//u_BlackOutColor
	// ***** Begin : All Vertices, Normals, Texture amd Etc data/Bindings *****
	...
	const GLchar *fragmentShaderSourceCode_Line =
		...
		"void main (void)" \
		"{"	\
		"	FragColor = vec4(1.0f,0.0f,0.0f,0.3f) * u_BlackOutColor;"	\
		"}";
	...
	g_scene2_1_Uniform_BlackOut_Line = glGetUniformLocation(g_scene2_Line_ShaderProgramObject, "u_BlackOutColor");
...
void Scene2_Display(void)
{
	...
	glUniform4fv(g_scene2_1_BlackoutColor, 1, blackOutColor);
	...
	if (g_scene2_1_iPresentViewPort_1 >= 0.0f)
	{
		...
		if (g_scene2_1_bShow_Inlet_Particle == true)
		{
			...
			//g_scene2_1_BlackOut_inlet
			glUniform4fv(g_scene2_1_BlackOut_inlet, 1, blackOutColor);
			glBindVertexArray(g_scene2_1_VertexArrayObject_Particle_Inlet);
		...
		if (g_scene2_1_bShow_Outlet_Particle == true)
		{
			...
			glUniform4fv(g_scene2_1_BlackOut_Outlet, 1, blackOutColor);
			glBindVertexArray(g_scene2_1_VertexArrayObject_Particle_Outlet);
		...
		if (g_scene2_1_bShow_Spark_Particle == true)
		{
			...
			glUniform4fv(g_scene2_1_BlackOut_Particle_Spark, 1, blackOutColor);
		...
		scaleMatrix = glm::mat4(1.0f);
		rotationMatrix = glm::mat4(1.0f);
		tdInletValveText.textColor[0] *= blackOutColor[0];
		tdInletValveText.textColor[1] *= blackOutColor[1];
		tdInletValveText.textColor[2] *= blackOutColor[2];
		...
		tdOutletletValveText.textColor[0] *= blackOutColor[0];
		tdOutletletValveText.textColor[1] *= blackOutColor[1];
		tdOutletletValveText.textColor[2] *= blackOutColor[2];
		...
		tdSparkPlugText.textColor[0] *= blackOutColor[0];
		tdSparkPlugText.textColor[1] *= blackOutColor[1];
		tdSparkPlugText.textColor[2] *= blackOutColor[2];
		...
		tdPistonText.textColor[0] *= blackOutColor[0];
		...
		{
		case 0:
			tdIntakeText.textColor[0] *= blackOutColor[0];
			tdIntakeText.textColor[1] *= blackOutColor[1];
			tdIntakeText.textColor[2] *= blackOutColor[2];
			frFontRenderer_IntakeText->renderText(&tdIntakeText, modelMatrix, viewMatrix, g_scene2_1_PerspectiveProjectionMatrix);
			break;
		case 1:
			tdCompressionText.textColor[0] *= blackOutColor[0];
			tdCompressionText.textColor[1] *= blackOutColor[1];
			tdCompressionText.textColor[2] *= blackOutColor[2];
			...
			break;
		case 2:
			tdPowerText.textColor[0] *= blackOutColor[0];
			tdPowerText.textColor[1] *= blackOutColor[1];
			tdPowerText.textColor[2] *= blackOutColor[2];
			frFontRenderer_PowerText->renderText(&tdPowerText, modelMatrix, viewMatrix, g_scene2_1_PerspectiveProjectionMatrix);
			break;
		case 3:
			tdExhaustText.textColor[0] *= blackOutColor[0];
			tdExhaustText.textColor[1] *= blackOutColor[1];
			tdExhaustText.textColor[2] *= blackOutColor[2];
		...
		glUniform4fv(g_scene2_1_Uniform_BlackOut_Line, 1, blackOutColor);
...
void Scene2_Update(void)
{
	...
	*************************************************************************************************************/
	...
	if (g_scene2_bBeginFadeOut == true)
	{
		...
		blackOutColor[3] -= 0.002f;

		g_pSS_Scene2_SoundSource->setVolume(blackOutColor[0]);
