...
#include "../../RTR_resources/resource.h"
...
{
    fontRenderer = new FontRenderer("RTR_resources/fonts/times.ttf", 78);
...
void CreditRoll::loadCreditRoll()
{
    ...
    loadTextDataFromFile("RTR_resources/creditRollData/creditRollData.txt", glm::vec3(0.0f, 0.0f, -6.0f), creditRollTextData);
}
...
void CreditRoll::loadGroupMembers()
{
    ...
    loadTextDataFromFile("RTR_resources/creditRollData/groupMembersColumn1.txt", textPosition, groupMembersTextData);

    textPosition = glm::vec3(-2.75f, previewRectFinalBottomY - 0.5f, -6.0f);
    loadTextDataFromFile("RTR_resources/creditRollData/groupMembersColumn2.txt", textPosition, groupMembersTextData);
}
