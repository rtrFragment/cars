...
struct Model
{
	...
	std::vector<Mesh_Data> gv_Mesh_Data;
	std::vector<material> gv_Material;
	char chMaterialFileName[512];
};
...
GLuint Scene1_BlackOut_Value_Uniform;
...
void Init_Scene1(void)
{
	...
	g_scene1_bShowScene1 = true;
	Init_Scene1_Car();

	//MessageBox(ghwnd, TEXT("Before LoadMeshData"), TEXT("MSG"), MB_OK);
	//Scene1_Gaurage_Body.count_of_vertices = LoadMeshData("RTR_resources/models/Gaurage/Gaurage_Body.obj", Scene1_Gaurage_Body.gv_vertices, Scene1_Gaurage_Body.gv_textures, Scene1_Gaurage_Body.gv_normals);
	LoadMeshData("RTR_resources/models/Gaurage/Gaurage_Body.obj", Scene1_Gaurage_Body.gv_vertices, Scene1_Gaurage_Body.gv_textures, Scene1_Gaurage_Body.gv_normals, Scene1_Gaurage_Body.gv_Mesh_Data, Scene1_Gaurage_Body.chMaterialFileName);

	//MessageBox(ghwnd, TEXT("After LoadMeshData 1"), TEXT("MSG"), MB_OK);
	LoadMeshData("RTR_resources/models/Gaurage/Outer_Lights.obj", Scene1_Gaurage_Outer_Light.gv_vertices, Scene1_Gaurage_Outer_Light.gv_textures, Scene1_Gaurage_Outer_Light.gv_normals, Scene1_Gaurage_Outer_Light.gv_Mesh_Data, Scene1_Gaurage_Outer_Light.chMaterialFileName);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 2"), TEXT("MSG"), MB_OK);
	LoadMeshData("RTR_resources/models/Gaurage/Inner_Gaurage_Upper_Light_Middle.obj", Scene1_Gaurage_Inner_Upper_Middle_Light.gv_vertices, Scene1_Gaurage_Inner_Upper_Middle_Light.gv_textures, Scene1_Gaurage_Inner_Upper_Middle_Light.gv_normals, Scene1_Gaurage_Inner_Upper_Middle_Light.gv_Mesh_Data, Scene1_Gaurage_Inner_Upper_Middle_Light.chMaterialFileName);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 3"), TEXT("MSG"), MB_OK);
	LoadMeshData("RTR_resources/models/Gaurage/Inner_Gaurage_Upper_Light_Side.obj", Scene1_Gaurage_Inner_Upper_Side_Light.gv_vertices, Scene1_Gaurage_Inner_Upper_Side_Light.gv_textures, Scene1_Gaurage_Inner_Upper_Side_Light.gv_normals, Scene1_Gaurage_Inner_Upper_Side_Light.gv_Mesh_Data, Scene1_Gaurage_Inner_Upper_Side_Light.chMaterialFileName);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 4"), TEXT("MSG"), MB_OK);
	LoadMeshData("RTR_resources/models/Gaurage/Inner_Gaurage_Side_Light.obj", Scene1_Gaurage_Inner_Side_Light.gv_vertices, Scene1_Gaurage_Inner_Side_Light.gv_textures, Scene1_Gaurage_Inner_Side_Light.gv_normals, Scene1_Gaurage_Inner_Side_Light.gv_Mesh_Data, Scene1_Gaurage_Inner_Side_Light.chMaterialFileName);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 5"), TEXT("MSG"), MB_OK);
	LoadMeshData("RTR_resources/models/Gaurage/Left_Door.obj", Scene1_Left_Door.gv_vertices, Scene1_Left_Door.gv_textures, Scene1_Left_Door.gv_normals, Scene1_Left_Door.gv_Mesh_Data, Scene1_Left_Door.chMaterialFileName);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 6"), TEXT("MSG"), MB_OK);
	LoadMeshData("RTR_resources/models/Gaurage/Right_Door.obj", Scene1_Right_Door.gv_vertices, Scene1_Right_Door.gv_textures, Scene1_Right_Door.gv_normals, Scene1_Right_Door.gv_Mesh_Data, Scene1_Right_Door.chMaterialFileName);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 6"), TEXT("MSG"), MB_OK);
	...
	Scene1_BlackOut_Value_Uniform = glGetUniformLocation(Scene1_gShaderProgramObject, "blackout");
...
void Display_Scene1(void)
{
	...
	if (gbLight == true)
	{
		...
		glUniform1f(Scene1_BlackOut_Value_Uniform, gfBlackOut);
	}
	else
	{
	...
	glDrawArrays(GL_TRIANGLES, 0, Scene1_Gaurage_Body.gv_vertices.size());
	...
	glDrawArrays(GL_TRIANGLES, 0, Scene1_Gaurage_Outer_Light.gv_vertices.size());
	...
	glDrawArrays(GL_TRIANGLES, 0, Scene1_Gaurage_Inner_Upper_Middle_Light.gv_vertices.size());
	...
	glDrawArrays(GL_TRIANGLES, 0, Scene1_Gaurage_Inner_Upper_Side_Light.gv_vertices.size());
	...
	glDrawArrays(GL_TRIANGLES, 0, Scene1_Gaurage_Inner_Side_Light.gv_vertices.size());
	...
	glDrawArrays(GL_TRIANGLES, 0, Scene1_Left_Door.gv_vertices.size());
	...
	glDrawArrays(GL_TRIANGLES, 0, Scene1_Right_Door.gv_vertices.size());
...
void Update_Scene1(void)
{
	...
	if (Scene1_camera_Z_counter == 599)
		gbScene1_Animate = true;

	if (Scene1_Car_Rotation_Completed_Flag == true && Scene1_camera_Z_counter <= 708)
	{
			Scene1_camera.MoveCamera(CameraMoveOnZ, -0.06f, deltaTime);
			Scene1_camera_Z_counter++;
...
void Scene1_initializeAudio(void)
{
	CommonHeader_InitializeAudioManager();
	//else
	//{
...
void Scene1_loadPointLightAudio()
{
	...
	ALboolean waveDataLoaded = Scene1_audioManager->loadWaveAudio("RTR_resources/audio/PointLight.wav", Scene1_audioBufferIdPointLight);
...
void Scene1_loadDoorOpeningAudio()
{
	...
	ALboolean waveDataLoaded = Scene1_audioManager->loadWaveAudio("RTR_resources/audio/DoorOpening.wav", Scene1_audioBufferIdDoorOpening);
...
void Scene1_loadSpotLightAudio(void)
{
	...
	ALboolean waveDataLoaded = Scene1_audioManager->loadWaveAudio("RTR_resources/audio/SpotLightSound.wav", Scene1_audioBufferIdSpotLight);
