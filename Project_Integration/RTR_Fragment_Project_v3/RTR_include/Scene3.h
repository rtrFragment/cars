...
Model_Scene3 g_Scene3_CityModel;
Model_Scene3 g_Scene3_GrassModel;
Model_Scene3 g_Scene3_SkyBoxModel;
//Instancing
Model_Scene3 g_Scene3_CityLightModel;
Model_Scene3 g_Scene3_PalmTreeModel;
Model_Scene3 g_Scene3_BenchModel;
...
void Init_Scene3()
{
	...
	LoadMeshData("RTR_resources/models/City/cityModelFin.obj", g_Scene3_CityModel.gv_vertices, g_Scene3_CityModel.gv_textures, g_Scene3_CityModel.gv_normals, Scene3_MD_City, Scene3_chMtlPath);
...
void Scene3_initializeCityModelWithShadow(void)
{
	...
	const GLchar *fragmentShaderSourceCode =
		...
		"vec3 normalized_transformed_normals = normalize(transformed_normals);" \
		"vec3 light_direction = u_light_position-eye_coordinates.xyz;"\
		"vec3 normalized_light_direction = normalize(light_direction);" \
