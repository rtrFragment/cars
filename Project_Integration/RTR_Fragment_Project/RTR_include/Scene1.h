...
void Init_Scene1(void)
{
	...
	Scene1_Gaurage_Outer_Light.count_of_vertices = LoadMeshData("RTR_resources/models/Gaurage/Outer_Lights.obj", Scene1_Gaurage_Outer_Light.gv_vertices, Scene1_Gaurage_Outer_Light.gv_textures, Scene1_Gaurage_Outer_Light.gv_normals);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 2"), TEXT("MSG"), MB_OK);
	Scene1_Gaurage_Inner_Upper_Middle_Light.count_of_vertices = LoadMeshData("RTR_resources/models/Gaurage/Inner_Gaurage_Upper_Light_Middle.obj", Scene1_Gaurage_Inner_Upper_Middle_Light.gv_vertices, Scene1_Gaurage_Inner_Upper_Middle_Light.gv_textures, Scene1_Gaurage_Inner_Upper_Middle_Light.gv_normals);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 3"), TEXT("MSG"), MB_OK);
	Scene1_Gaurage_Inner_Upper_Side_Light.count_of_vertices = LoadMeshData("RTR_resources/models/Gaurage/Inner_Gaurage_Upper_Light_Side.obj", Scene1_Gaurage_Inner_Upper_Side_Light.gv_vertices, Scene1_Gaurage_Inner_Upper_Side_Light.gv_textures, Scene1_Gaurage_Inner_Upper_Side_Light.gv_normals);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 4"), TEXT("MSG"), MB_OK);
	Scene1_Gaurage_Inner_Side_Light.count_of_vertices = LoadMeshData("RTR_resources/models/Gaurage/Inner_Gaurage_Side_Light.obj", Scene1_Gaurage_Inner_Side_Light.gv_vertices, Scene1_Gaurage_Inner_Side_Light.gv_textures, Scene1_Gaurage_Inner_Side_Light.gv_normals);
	//MessageBox(ghwnd, TEXT("After LoadMeshData 5"), TEXT("MSG"), MB_OK);
	Scene1_Left_Door.count_of_vertices = LoadMeshData("RTR_resources/models/Gaurage/Left_Door.obj", Scene1_Left_Door.gv_vertices, Scene1_Left_Door.gv_textures, Scene1_Left_Door.gv_normals);
