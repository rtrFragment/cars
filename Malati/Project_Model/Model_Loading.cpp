//Cubemap Code refer From LearnOpenGL SIte
#include<windows.h>
#include<windowsx.h>
...
Camera camera;
//Camera camera(glm::vec3(0.0f, 1.0f, 3.0f), glm::vec3(0.0f, 0.0f, 2.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
void initialize(void)
{
	...
	glVertexAttribPointer(HAD_ATTRIBUTE_POSITION, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(HAD_ATTRIBUTE_POSITION);
	...
	{
/*
		"resources/miramar/miramar_lf.tga",
		"resources/miramar/miramar_rt.tga",

		"resources/miramar/miramar_dn.tga",
		"resources/miramar/miramar_up.tga",

		"resources/miramar/miramar_ft.tga",
		"resources/miramar/miramar_bk.tga",*/
...
void LoadSkyBoxShader()
{
	...
	glBindAttribLocation(gShaderProgramObjectSkyBox, HAD_ATTRIBUTE_POSITION, "aPos");
	...
	gViewSkyBoxUniform = glGetUniformLocation(gShaderProgramObjectSkyBox, "view");
	gSkyboxUniform = glGetUniformLocation(gShaderProgramObjectSkyBox, "skybox");
	//gModelSkyboxUniform = glGetUniformLocation(gShaderProgramObjectSkyBox, "model");
...
//	modelMatrix = scaleMatrix * modelMatrix;
	...
	//glUniformMatrix4fv(gModelSkyboxUniform, 1, GL_FALSE, glm::value_ptr(modelMatrix));
	glUniformMatrix4fv(gViewSkyBoxUniform, 1, GL_FALSE, glm::value_ptr(view));
	glUniformMatrix4fv(gProjectionSkyBoxUniform, 1, GL_FALSE, glm::value_ptr(gPerspectiveProjectionMatrix));
	...
	glUniformMatrix4fv(gViewMatrixUniform, 1, GL_FALSE, glm::value_ptr(view));
